...
支持京东双账号
东东超市兑换奖品请使用此脚本 https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_blueCoin.js
...
=======Surge===========
东东超市 = type=cron,cronexp="11 1-23/5 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_superMarket.js
==============小火箭=============
东东超市 = type=cron,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_superMarket.js, cronexpr="11 1-23/5 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东超市');
