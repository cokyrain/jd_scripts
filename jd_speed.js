...
[task_local]
#天天加速
8 0-23/3 * * * https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_speed.js, tag=京东天天加速, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdjs.png, enabled=true

============Loon================
[Script]
cron "8 0-23/3 * * *" script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_speed.js,tag=京东天天加速

===========Surge============
天天加速 = type=cron,cronexp="8 0-23/3 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_speed.js

==============小火箭=============
天天加速 = type=cron,script-path=https://raw.githubusercontent.com/cokyrain/jd_scripts/master/jd_speed.js, cronexpr="11 0-23/3 * * *", timeout=3600, enable=true
*/
